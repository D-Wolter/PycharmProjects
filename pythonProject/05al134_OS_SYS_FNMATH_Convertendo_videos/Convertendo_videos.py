#https://ffmpeg.zeranoe.com/buids/

"""
ffmpeg -i 'entrada' -i 'legenda' -c:v libx264 -crf 23 -preset iltrafast -c:a aac -b:a 320k
-c:s srt -map c:0 -map a _map 1:0
"""
...
caminho_origem = '/home/dwolter/Videos/videoclip'
caminho_destino = '/home/dwolter/Videos/new'
